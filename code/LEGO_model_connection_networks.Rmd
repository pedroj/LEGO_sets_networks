...
set_id<- "7131-2-PJ" ###### <<<<<------- Input set code here.
set_num<- set_id
...
my_image_array <- readPNG(here::here(paste0("images/starwars_sets_images/",setname,".png")))
...
V(g)$color_id <- target_set_parts$color_id  
                           # 7, Light_grey example; get from parts_json$results$color_id
...
plot_bend_net(g, coords, my_image)
