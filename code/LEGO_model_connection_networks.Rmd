...
set_id<- "601-1" ###### <<<<<------- Input set code here.
set_num<- set_id
...
setname<- extract_mpd_set_name(here::here("data/models/601-2-Tow_Truck.mpd"))
...
my_image <- readPNG(here::here(paste0("images/",setname,".png"))) #, 
                             #  native = TRUE))
my_image <- readPNG(here::here(paste0("images/601-1-Tow_Truck.png"))) #, 
...
my_image_array <- readPNG(here::here(paste0("images/", setname, ".png")))
